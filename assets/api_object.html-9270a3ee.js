import{_ as n,o as s,c as a,e as t}from"./app-b7f671b0.js";const e={},p=t(`<h1 id="api-object" tabindex="-1"><a class="header-anchor" href="#api-object" aria-hidden="true">#</a> API Object</h1><p>API Object Models，简称AOM，AOM是一种设计模式，它围绕着将API、路由或功能交互及其相关行为封装在结构良好的对象中。AOM旨在增强API测试和集成的直观性和弹性。在实践中，AOM需要精心设计专门的API对象，以有效地保护用户免受与API 请求、响应、端点交互和身份验证过程相关的复杂性的影响。</p><p>seldom 支持AOM, 并且提供了一些好用的功能，辅助你使用AOM.</p><ul><li>目录结构如下</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>mypro/
├── api/
│   ├── __init__.py
│   ├── auth_object.py
│   └── xxx_object.py
