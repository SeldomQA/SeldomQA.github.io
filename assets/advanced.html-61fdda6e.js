import{_ as n,o as s,c as a,e as t}from"./app-e3fbc58a.js";const e={},p=t(`<h1 id="高级用法" tabindex="-1"><a class="header-anchor" href="#高级用法" aria-hidden="true">#</a> 高级用法</h1><h3 id="fixture" tabindex="-1"><a class="header-anchor" href="#fixture" aria-hidden="true">#</a> fixture</h3><p>有时自动化测试用例的运行需要一些前置&amp;后置步骤，seldom提供了相应的方法。</p><p><strong>start &amp; end</strong></p><p>针对每条用例的fixture，可以放到<code>start()/end()</code>方法中。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> seldom
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>运行结果</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>名字： Hayden
名字（男）： Brantley
名字（女）： Julia
名字（中文男）： 觅儿
名字（中文女）： 若星
...
姓名: Genesis
姓名（中文）: 廉高义
生日: <span class="token number">2000</span>-03-11
生日字符串: <span class="token number">1994</span>-11-12
生日年龄范围: <span class="token number">1996</span>-01-12
日期（当前）: <span class="token number">2022</span>-09-17
日期（昨天）: <span class="token number">2022</span>-09-16
日期（明天）: <span class="token number">2022</span>-09-18
数字<span class="token punctuation">(</span><span class="token number">8</span>位<span class="token punctuation">)</span>: <span class="token number">48285099</span>
邮箱: melanie@yahoo.com
浮点数: <span class="token number">1</span>.5315717275531858e+308
浮点数范围: <span class="token number">1.6682402084146244</span>
当前时间: <span class="token number">2022</span>-09-17 <span class="token number">23</span>:33:22.736031
当前时间<span class="token punctuation">(</span>格式化字符串<span class="token punctuation">)</span>: <span class="token number">2022</span>-09-17 <span class="token number">23</span>:33:22
未来时间: <span class="token number">2054</span>-05-02 <span class="token number">11</span>:33:47.736031
未来时间<span class="token punctuation">(</span>格式化字符串<span class="token punctuation">)</span>: <span class="token number">2070</span>-08-28 <span class="token number">16</span>:38:45
过去时间: <span class="token number">2004</span>-09-03 <span class="token number">12</span>:56:23.737031
过去时间<span class="token punctuation">(</span>格式化字符串<span class="token punctuation">)</span>: <span class="token number">2006</span>-12-06 07:58:37
整型: <span class="token number">7831034423589443450</span>
整型32位: <span class="token number">1119927937</span>
整型64位: <span class="token number">3509365234787490389</span>
MD5: d0f6c6abbfe1cfeea60ecfdd1ef2f4b9
UUID: 5fd50475-2723-4a36-a769-1d4c9784223a
单词: habitasse
单词组（3个）: уж pede. metus.
手机号: <span class="token number">13171039843</span>
手机号<span class="token punctuation">(</span>移动<span class="token punctuation">)</span>: <span class="token number">15165746029</span>
手机号<span class="token punctuation">(</span>联通<span class="token punctuation">)</span>: <span class="token number">16672812525</span>
手机号<span class="token punctuation">(</span>电信<span class="token punctuation">)</span>: <span class="token number">17345142737</span>
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    seldom<span class="token punctuation">.</span>main<span class="token punctuation">(</span>debug<span class="token operator">=</span><span class="token boolean">True</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,90),o=[p];function c(l,i){return s(),a("div",null,o)}const d=n(e,[["render",c],["__file","advanced.html.vue"]]);export{d as default};
