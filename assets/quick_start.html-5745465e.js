import{_ as t,r as e,o as p,c as o,a as n,b as s,d as i,e as l}from"./app-b7f671b0.js";const c="/image/pycharm.png",u="/image/pycharm_run_case.png",d="/image/report.png",r={},k=n("h1",{id:"快速开始",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#快速开始","aria-hidden":"true"},"#"),s(" 快速开始")],-1),v=n("h3",{id:"基本规范",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#基本规范","aria-hidden":"true"},"#"),s(" 基本规范")],-1),m=n("code",null,"seldom",-1),b=n("code",null,"unittest",-1),q={href:"https://docs.python.org/3/library/unittest.html",target:"_blank",rel:"noopener noreferrer"},_=l(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># test_sample.py</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>基本规范：</p><ol><li>创建测试类<code>YouTest</code>并继承<code>seldom.TestCase</code>类。</li><li>创建测试方法<code>test_case</code>, 必须以<code>test</code>开头。</li><li><code>seldom.mian()</code>是框架运行的入口方法，接下来详细介绍。</li></ol><h3 id="main-方法" tabindex="-1"><a class="header-anchor" href="#main-方法" aria-hidden="true">#</a> <code>main()</code> 方法</h3><p><code>main()</code>方法是seldom运行测试的入口, 它提供了一些最基本也是最重要的配置。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> seldom
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行相关的配置，可以在<code>confrun.py</code> 文件中配置。</p><p><strong>3. 在pyCharm中运行测试</strong></p><blockquote><p>强烈不建议这种方式，除非你的测试用例没有任何依赖。</p></blockquote><p>步骤一：配置测试用例通过 unittest 运行。</p><p><img src="`+c+'" alt=""></p><p>步骤二：在文件中选择测试类或用例执行。</p><p><img src="'+u+`" alt=""></p><blockquote><p>警告：运行用例打开的浏览器，需要手动关闭， seldom不做用例关闭操作。</p></blockquote><h3 id="失败重跑" tabindex="-1"><a class="header-anchor" href="#失败重跑" aria-hidden="true">#</a> 失败重跑</h3><p>Seldom支持<code>错误</code>&amp;<code>失败</code>重跑。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># test_sample.py</span>
<span class="token keyword">import</span> seldom
...
│   ├── seldom_log.log
└── test_sample.py
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过浏览器打开 <code>2020_01_01_11_20_33_result.html</code> 测试报告，查看测试结果。</p><p><img src="`+d+`" alt=""></p><p><strong>debug模式</strong></p><p>如果不想每次运行都生成HTML报告，可以打开<code>debug</code>模式。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> seldom
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,79);function g(h,y){const a=e("ExternalLinkIcon");return p(),o("div",null,[k,v,n("p",null,[m,s("继承"),b,s("单元测试框架，所以他的编写规范与"),n("a",q,[s("unittest"),i(a)]),s("基本保持一致。")]),_])}const w=t(r,[["render",g],["__file","quick_start.html.vue"]]);export{w as default};
