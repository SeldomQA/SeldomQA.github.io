import{_ as s,o as a,c as e,e as p}from"./app-29570897.js";const t={};function i(l,n){return a(),e("div",null,n[0]||(n[0]=[p(`<h1 id="app-测试" tabindex="-1"><a class="header-anchor" href="#app-测试" aria-hidden="true">#</a> app 测试</h1><p><code>seldom 3.0</code> 基于appium支持APP测试。</p><p>appium 官方网站：https://appium.io/</p><h2 id="环境安装" tabindex="-1"><a class="header-anchor" href="#环境安装" aria-hidden="true">#</a> 环境安装</h2><p>app 的自动化测试环境相比较 web 要复杂一些，请参考appium官方。</p><ol><li>安装node</li></ol><p>https://nodejs.org/en/</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">node</span> <span class="token parameter variable">--version</span>
v16.17.0
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,24)]))}const c=s(t,[["render",i],["__file","start.html.vue"]]);export{c as default};
