import{_ as o,r as p,o as c,c as i,e as s,a,b as e,d as l}from"./app-29570897.js";const u={},d={href:"https://github.com/ae86sen/aomaker",target:"_blank",rel:"noopener noreferrer"};function r(k,n){const t=p("ExternalLinkIcon");return c(),i("div",null,[n[2]||(n[2]=s('<h1 id="方法的依赖" tabindex="-1"><a class="header-anchor" href="#方法的依赖" aria-hidden="true">#</a> 方法的依赖</h1><blockquote><p>在 seldom 3.4.0 版本实现了该功能。</p></blockquote><p>在复杂的测试场景中，常常会存在用例依赖，以一个接口自动化平台为例，依赖关系：</p><p><code>创建用例</code> --&gt; <code>创建模块</code> --&gt; <code>创建项目</code> --&gt; <code>登录</code>。</p><p><strong>用例依赖的问题</strong></p><ul><li>用例的依赖对于的执行顺序有严格的要求，比如让被依赖的方法先执行。</li><li>一旦使用用例依赖，依赖的用例就无法单独执行了，按照用例的设计原则，每条用例都应该独立执行。</li></ul><p><strong>正确的做法</strong></p><p><code>我们应该将依赖的操作封装成方法调用</code>。如果能通过装饰器实现调用，那就很有趣了。</p>',8)),a("p",null,[a("a",d,[n[0]||(n[0]=e("aomaker")),l(t)]),n[1]||(n[1]=e(" 提供了这种装饰器的实现，seldom 进行了复刻，只是的定位和用法用有所不同。"))]),n[3]||(n[3]=s(`<h3 id="类内部方法调用" tabindex="-1"><a class="header-anchor" href="#类内部方法调用" aria-hidden="true">#</a> 类内部方法调用</h3><p>我们可以在测试类下面，创建普通的方法。然后通过<code>@dependent_func()</code>装饰器调用他。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> seldom
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    seldom<span class="token punctuation">.</span>main<span class="token punctuation">(</span>debug<span class="token operator">=</span><span class="token boolean">True</span><span class="token punctuation">)</span>
    cache<span class="token punctuation">.</span>clear<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>说明</strong></p><ol><li><code>@data()</code> 装饰器必须写在 <code>@dependent_func()</code> 的上面。</li><li>运行两条用例，<code>user_login()</code> 被执行过一次后，第二次则不需要重复执行，直接返回结果。</li></ol>`,31))])}const v=o(u,[["render",r],["__file","dependent_func.html.vue"]]);export{v as default};
