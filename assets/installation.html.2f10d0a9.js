import{_ as s,e as n}from"./app.eb6903a4.js";const a={},e=n(`<h1 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h1><p>seldom\u7684\u5B89\u88C5\u975E\u5E38\u7B80\u5355\u3002</p><ul><li>\u5FEB\u901F\u5B89\u88C5</li></ul><p>\u76EE\u524D\u5DF2\u7ECF\u4E0A\u4F20 pypi.org ,\u53EF\u4EE5\u4F7F\u7528pip\u547D\u4EE4\u5B89\u88C5\u3002</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token operator">&gt;</span> pip <span class="token function">install</span> seldom
...
webdriver-manager<span class="token operator">==</span><span class="token number">3.8</span>.2
...
Name: seldom
Version: <span class="token number">3.0</span>.0
...
License: BSD
Location: c:<span class="token punctuation">\\</span>users<span class="token punctuation">\\</span>xxx<span class="token punctuation">\\</span>.virtualenvs<span class="token punctuation">\\</span>seldom-wkum2rzm<span class="token punctuation">\\</span>lib<span class="token punctuation">\\</span>site-packages
