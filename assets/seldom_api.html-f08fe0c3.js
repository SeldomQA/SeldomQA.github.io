import{_ as o,r as i,o as c,c as l,e as t,a as s,b as e,d as p}from"./app-29570897.js";const u={},d={href:"https://www.w3school.com.cn/cssref/css_selectors.asp",target:"_blank",rel:"noopener noreferrer"},r={href:"https://www.w3school.com.cn/xpath/xpath_syntax.asp",target:"_blank",rel:"noopener noreferrer"};function k(m,n){const a=i("ExternalLinkIcon");return c(),l("div",null,[n[2]||(n[2]=t(`<h1 id="seldom-api" tabindex="-1"><a class="header-anchor" href="#seldom-api" aria-hidden="true">#</a> Seldom API</h1><h3 id="查找元素" tabindex="-1"><a class="header-anchor" href="#查找元素" aria-hidden="true">#</a> 查找元素</h3><p>seldom 提供了8中定位方式，与Selenium保持一致。</p><ul><li>id_</li><li>name</li><li>class_name</li><li>tag</li><li>link_text</li><li>partial_link_text</li><li>css</li><li>xpath</li></ul><p><strong>使用方式</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># **kwargs</span>
