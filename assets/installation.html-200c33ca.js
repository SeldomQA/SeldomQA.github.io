import{_ as s,o as n,c as a,e}from"./app-e3fbc58a.js";const l={},i=e(`<h1 id="installation" tabindex="-1"><a class="header-anchor" href="#installation" aria-hidden="true">#</a> Installation</h1><p>seldom的安装非常简单。</p><ul><li>快速安装</li></ul><p>目前已经上传 pypi.org ,可以使用pip命令安装。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> pip <span class="token function">install</span> seldom
