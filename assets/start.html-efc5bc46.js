import{_ as n,o as s,c as a,e}from"./app-1e874560.js";const p={},t=e(`<h1 id="app-测试" tabindex="-1"><a class="header-anchor" href="#app-测试" aria-hidden="true">#</a> app 测试</h1><p><code>seldom 3.0</code> 基于appium支持APP测试。</p><p>appium 官方网站：https://appium.io/</p><h2 id="环境安装" tabindex="-1"><a class="header-anchor" href="#环境安装" aria-hidden="true">#</a> 环境安装</h2><p>app 的自动化测试环境相比较 web 要复杂一些，请参考appium官方。</p><ol><li>安装node</li></ol><p>https://nodejs.org/en/</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">node</span> <span class="token parameter variable">--version</span>
v16.17.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>安装appium</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> appium  <span class="token comment"># get appium 1.x</span>
<span class="token operator">&gt;</span> <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> appium@next <span class="token comment"># get appium 2.x</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>启动appium</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> appium
