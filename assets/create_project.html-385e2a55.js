...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>根据自己的需求编写<code>Web UI</code>、<code>App UI</code>或<code>HTTP接口</code>自动化测试。</p>`,21),t=[i];function p(c,o){return a(),n("div",null,t)}const d=s(l,[["render",p],["__file","create_project.html.vue"]]);export{d as default};
