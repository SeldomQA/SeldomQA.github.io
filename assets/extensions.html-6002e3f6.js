import{_ as n,o as s,c as a,e as p}from"./app-9fb6f1b5.js";const t={},e=p(`<h1 id="appium-扩展" tabindex="-1"><a class="header-anchor" href="#appium-扩展" aria-hidden="true">#</a> appium 扩展</h1><p>appium支持扩展，通过扩展来增强appium定位元素的能力。</p><h2 id="appium-images-plugin" tabindex="-1"><a class="header-anchor" href="#appium-images-plugin" aria-hidden="true">#</a> appium images-plugin</h2><p>使用此插件支持的<code>-image</code>定位器策略，可以通过Appium指定想要定位的元素的图片文件。</p><ul><li>安装Appium images-plugin插件。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> appium plugin <span class="token function">install</span> images
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>JSON结构体说明：</p><ul><li><p>wrods - Tesseract识别的单个单词的列表。</p></li><li><p>lines - Tesseract识别的文本行的列表。</p></li><li><p>blocks - Tesseract识别连续文本块的列表。</p></li></ul><p>每项都引用一个OCR对象，它们本身包含3个数据：</p><ul><li>text：识别的文本。</li><li>confidence：Tesseract对于给定文本的OCR处理结果的置信度（范围在0到100之间）。</li><li>bbox：发现文本的边界框，<code>边界框</code>标记为x0、x1、y0和y1的值的对象。分别表文本的上下左右坐标位置，其中。这里，x0表示发现文本的左边x坐标，x1表示右边x坐标，y0表示上部y坐标，y1表示下部y坐标。</li></ul>`,30),o=[e];function i(l,c){return s(),a("div",null,o)}const r=n(t,[["render",i],["__file","extensions.html.vue"]]);export{r as default};
