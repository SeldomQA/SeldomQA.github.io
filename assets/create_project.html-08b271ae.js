...
Options:
  ...
  -m, <span class="token parameter variable">--mod</span> TEXT                  Run tests modules, classes or even
                                  ...
                                  line.
  -i, <span class="token parameter variable">--install</span> <span class="token punctuation">[</span>chrome<span class="token operator">|</span>firefox<span class="token operator">|</span>ie<span class="token operator">|</span>edge<span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>根据自己的需求编写<code>Web UI</code> or<code>HTTP接口</code>自动化测试。</p>`,21),t=[i];function p(o,c){return s(),n("div",null,t)}const d=a(l,[["render",p],["__file","create_project.html.vue"]]);export{d as default};
