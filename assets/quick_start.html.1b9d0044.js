...
<span class="token operator">&gt;</span> seldom -p .<span class="token punctuation">\\</span>test_dir<span class="token punctuation">\\</span>  <span class="token comment"># \u8FD0\u884C\u76EE\u5F55</span>
<span class="token operator">&gt;</span> seldom -p .<span class="token punctuation">\\</span>test_dir<span class="token punctuation">\\</span>test_sample.py  <span class="token comment"># \u8FD0\u884C\u6587\u4EF6</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div>`,62);function x(T,C){const a=e("ExternalLinkIcon");return t(),o(c,null,[k,d,n("p",null,[_,q,g,h,n("a",y,[f,l(a)]),v]),w],64)}var E=p(m,[["render",x],["__file","quick_start.html.vue"]]);export{E as default};
