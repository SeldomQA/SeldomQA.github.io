import{_ as n,o as s,c as a,e as t}from"./app-b7f671b0.js";const e={},p=t(`<h1 id="高级用法" tabindex="-1"><a class="header-anchor" href="#高级用法" aria-hidden="true">#</a> 高级用法</h1><h3 id="fixture" tabindex="-1"><a class="header-anchor" href="#fixture" aria-hidden="true">#</a> fixture</h3><p>有时自动化测试用例的运行需要一些前置&amp;后置步骤，seldom提供了相应的方法。</p><p><strong>start &amp; end</strong></p><p>针对每条用例的fixture，可以放到<code>start()/end()</code>方法中。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> seldom
